...
<div class="row">
    ...
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Form Update Data Video</h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br />
                <?php
                foreach ($data_video_edit as $tampilkan_video) :
                ?>
                    <form class="form-horizontal form-label-left" action="<?php echo base_url() ?>Video/Update" method="POST" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="control-label col-md-3 col-sm-3 col-xs-3">Judul</label>
                            <div class="col-md-9 col-sm-9 col-xs-9">
                                <input type="hidden" name="id_galery" value="<?php echo $tampilkan_video->id_galery ?>">
                                <input type="text" class="form-control" name="judul" value="<?php echo $tampilkan_video->judul ?>">
                                <span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9">
                                <input type="text" name="isi" class="form form-control" value="<?php echo $tampilkan_video->deskripsi ?>">
                                <span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9">
                                <input type="text" name="url" class="form form-control" value="<?php echo $tampilkan_video->url ?>">
                                <span>
