                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <?php
                                    foreach ($data_proju as $tampilkan_proju) {
                                        ...
                                        echo "</td>";
                                        echo "<td><a href='Kategori/Edit/$tampilkan_proju->id_proju'><button class='btn btn-primary btn-sm' title='Edit'><li class='fa fa-edit'></li></button></a> <button class='btn btn-danger btn-sm' title='Hapus' onClick='hapus($tampilkan_proju->id_proju)'><li class='fa fa-trash'></li></button></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </tbody>
